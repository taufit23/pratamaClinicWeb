...
<template>
    <AuthenticatedLayout
        ...
        :text="'Data Pasien / Username : ' + user.username"
    >
        <div
            id="profile"
        ...
        >
            <div class="items-center w-full p-4 md:p-12 lg:text-left">
                ...
                >
                    ...
                    <div
                        class="pt-3 mx-auto border-b-2 border-red-500 opacity-50 w-5/5 lg:mx-0"
                    ></div>
                    <div>
                        <p
                            class="flex items-center justify-center pt-4 text-base font-bold lg:justify-start"
                        >
                            <CIcon
                                :icon="icon.cilUserX"
                                size="sm"
                                                ...
                                                >
                                                    ...
                                                    <td class="">
                                                        ...
                                                        <Link
                                                            ...
                                                            "
                                                            class="px-4 py-1 mx-1 text-sm text-red-400 bg-sky-200 rounded-full"
                                                        >
                                                            Detail</Link
                                                        >
                                                    </td>
