...
import PAlamat from './Component/PAlamat.vue';
</script>
<template>
    <AuthenticatedLayout :href="route('profile.index')" text="Profile">
        <!--Main Col-->
        <div id="profile"
            class="w-full mx-6 bg-white rounded-lg shadow-2xl opacity-75 lg:w-full lg:rounded-l-lg lg:rounded-r-none lg:mx-0">
            <div class="p-4 text-center md:p-12 lg:text-left">
                <H1Name v-if="$page.props.auth.user.role == 'pasien'" >{{ $page.props.auth.user.pasien.name }}</H1Name>
                <H1Name v-if="$page.props.auth.user.role == 'dokter'" >{{ $page.props.auth.user.dokter.name }}</H1Name>
                <H1Name v-if="$page.props.auth.user.role == 'admin'" >{{ $page.props.auth.user.admin.name }}</H1Name>
                ...
                <PAlamat v-if="$page.props.auth.user.role == 'pasien'"> {{ $page.props.auth.user.pasien.alamat }}</PAlamat>
