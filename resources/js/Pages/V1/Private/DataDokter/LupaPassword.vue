...
<template>
    <AuthenticatedLayout :href="route('admin.dokter.index')" text="Data Dokter / Ubah Pasword">
        <form @submit.prevent="form.put(route('admin.dokter.post_new_password', user.id), { onSuccess: () => form.reset() })">
            <div class="flex flex-wrap mb-3 -mx-3">
                <div class="w-full px-3 mb-6 md:w-1/2 md:mb-0">
                    <PublicInputText :label="'Password BAru'" :type="'password'" :placeholder="'Ex : *********'"
