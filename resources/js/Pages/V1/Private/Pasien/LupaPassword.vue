...
<template>
    <AuthenticatedLayout :href="route('admin.pasien.index')" text="Data Pasien / Ubah Pasword">
        <form @submit.prevent="form.put(route('admin.pasien.new_password', user.id), { onSuccess: () => form.reset() })">
