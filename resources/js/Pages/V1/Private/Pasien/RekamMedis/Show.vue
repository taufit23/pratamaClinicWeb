...
console.log(props.rekam_medis.layanan);
</script>
<template>
        ...
        <section class="text-gray-600 body-font">
            <div class="container mx-auto">
                <div class="flex flex-col flex-wrap items-center w-full text-center">
                    ...
                    <p>Nama dokter : {{ rekam_medis.dokter.name }}</p>
                </div>
                                                            ...
                                                            <div class="border-b border-gray-200 shadow">
                                                                <table class="divide-y divide-gray-300">
                                                                    ...
                                                                    <tbody class="bg-white divide-y divide-gray-300">
                                                                        <tr v-for="pelayanan in rekam_medis.layanan"
                                                                            :key="
                                                                                pelayanan.id
                                                                            "
                                                                        ...
                                                                        <tr class="whitespace-nowrap">
                                                                            ...
                                                                            <td class="px-6 py-4">
                                                                                <div class="text-sm text-gray-900">
                                                                                    {{ rekam_medis.pembayaran.total_bayar
                                                                                    }}
                                                                                </div>
                                                                            </td>
                                                                        </tr>
                                                                        <tr class="whitespace-nowrap">
                                                                            ...
                                                                            <td class="px-6 py-4">
                                                                                <div v-if="rekam_medis.pembayaran.status_bayar == null"
                                                                                     class="text-sm text-gray-900">
                                                                                    Belum bayar
                                                                                </div>
                                                                                <div v-if="rekam_medis.pembayaran.status_bayar == 'lunas'"
                                                                                     class="text-sm text-gray-900">
                                                                                    Sudah bayar
                                                                                </div>
                                                                            </td>
